      ...
      <header className="position-fixed top-0 left-0 right-0 font-weight-semibold no-print">
        ...
        >
          ...
          <div className="logo-container">
            ...
            <Link href="/">
              <a>
                <img
                  src="/images/otani-skin-therapy.svg"
        ...
        <Transition in={showMobileMenu} timeout={duration}>
          {state => (
            ...
            >
              <div className="position-absolute top-0 left-0 right-0 h-100vh mobile-menu-inner bg-black700 d-flex flex-column justify-content-center">
